...
public class MaterialDAO implements Persistible<Material> {
	...
	public ArrayList<Material> getAllUsuario(int idUsu) {
		ArrayList<Material> lista = new ArrayList<Material>();
	...
	public Material getById(int id) {
		...
		String sql = "SELECT material.id, material.nombre, precio, u.id as 'id_usuario', u.nombre as 'nombre_usuario' FROM `material`,`usuario` as u WHERE material.`id` = ? AND material.id_usuario = u.id ;";
	...
	private boolean modificarUsuario(Material pojo,int idUsu ) {
		boolean resul = false;
	...
	//delete para usuario
	public boolean deleteUsuario(int id,int idUsu) {
		boolean resul = false;
...
//Añadir rol
	...
	public ArrayList<Material> search(String nombreBuscar) {
		ArrayList<Material> lista = new ArrayList<Material>();
		String sql = "SELECT material.id, material.nombre, precio, u.id as 'id_usuario', u.nombre as 'nombre_usuario' FROM `material`,`usuario` as u WHERE material.`nombre` LIKE ?AND material.id_usuario = u.id  ORDER BY `id` DESC LIMIT 500;";
		try (Connection con = ConnectionManager.getConnection(); PreparedStatement pst = con.prepareStatement(sql);) {
