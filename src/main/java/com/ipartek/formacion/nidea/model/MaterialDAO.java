...
public class MaterialDAO implements Persistible<Material> {
	...
	public Material getById(int id) {
		...
		String sql = "SELECT material.id, material.nombre, material.precio, material.id_usuario, usuario.id as 'id_usuario', usuario.nombre as 'nombre_usuario' FROM material, usuario WHERE material.id_usuario = usuario.id AND material.id = ? ;";
