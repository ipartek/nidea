...
public class MaterialesController extends HttpServlet {
	...
	private void eliminar(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (daoMaterial.deleteUsuario(id,usuario_id)) {
	...
	private void listar(HttpServletRequest request) {
		...
		recogerParametros(request);
		materiales = daoMaterial.getAllUsuario(usuario_id);
		request.setAttribute("materiales", materiales);
		dispatcher = request.getRequestDispatcher(VIEW_INDEX);
	...
	private void recogerParametros(HttpServletRequest request) {
		...
		//Al ser el front recibe de sesion el ususario
		usuario_id = (int) ((Usuario) request.getSession().getAttribute("usuario")).getId();
