	...
	<form action="backoffice/materiales" method="post">
		...
		<div class="input-group">
			<div class="col">
				...
				<input type="text" value="${material.usuario.nombre}" disabled
					readonly />
			</div>
			<div class="col">
				<p>Cambiar usuario</p>
				<input type="search" id="search" placeholder="Nombre usuario"
					onkeyup="buscarUsuario(event)"> <input type="hidden"
					name="id_usuario" value="${material.usuario.id}"> <select
					id="sUsuarios" name="id_usuario_cambio" style="color:red;"></select>
			</div>
		</div>
