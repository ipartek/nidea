...
window.onload = function(e) {
	...
	nombre_mensaje = document.getElementById('nombre_mensaje');
		...
		if(nombre.value.length>=5){
			...
			validarNombre().then(result=>{
				...
				if(result == true){
					...
					nombre_mensaje.style.color = "green";
					nombre_mensaje.innerText = "Nombre disponible";
					
				} else {
					
					nombre.style.border = "3px solid red";
					nombre_mensaje.style.color = "red";
					nombre_mensaje.innerText = "Nombre no disponible";		
				}
				toggleButton();
			});			
		} else if (nombreCheck){
			...
			nombre.style.border = "3px solid red";
			nombre_mensaje.style.color = "red";
			nombre_mensaje.innerText = "Nombre demasiado corto";
