...
<div class="container">
	<div class="form-group row">
		<a class="btn btn-outline-dark btn-lg" href="frontoffice/materiales?op=3">Volver</a>
	</div>
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
						      ...
						      <div class="modal-footer">
						        ...
						        <a href="frontoffice/materiales?id=${material.id}&op=<%=MaterialesController.OP_ELIMINAR%>">
